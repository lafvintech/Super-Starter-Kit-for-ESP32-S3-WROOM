...
about its functions. Move the program folder :file:`Super_Starter_Kit_for_ESP32_S3/Python/Python_Codes` to disk(D) in advance with the path of “D:/Micropyth
on_Codes”. 

Open “Thonny”, click :file:`This computer/D:/Micropython_Codes/13.1_Flowing_Water_Light`. Select “my74HC595.py”, right click your mouse to select “Upload to /”, wait 
