...
ESP32_WS2812::ESP32_WS2812(uint16_t n /*= 8*/, uint8_t pin_gpio /*= 2*/, uint8_t chn /*= 0*/, LED_TYPE t /*= TYPE_GRB*/)
{
	ledCounts = n;
	pin = pin_gpio;
	rmt_chn = chn;
...
esp_err_t ESP32_WS2812::set_pixel(int index, uint8_t r, uint8_t g, uint8_t b)
{
